...
// renewalDueDate, which stays a manual field edited on the policy itself.
...
export default function HealthPremiumForm({ policyId, defaultAmount, onClose, onSaved }) {
  ...
  const submit = async (e) => {
    ...
    setError(null);
    try {
      const saved = await api.addHealthPremium(policyId, { paidOn, amount, notes }, files);
      onSaved(saved);
    } catch (err) {
